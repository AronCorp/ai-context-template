...
3. Follow along. It reads the guide from this page, asks your first name, helps you make a GitHub account if you need one, gets your own private copy of these files made (ChatGPT does it in a browser you watch, where you log in and approve; on Claude you make it yourself from one link, four taps, and Claude fills it through its GitHub connection, which you approve once), then interviews you and fills the files in. Plan on two or three sittings; you can stop any time.
