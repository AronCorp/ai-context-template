...
- "save it": one change, saved to GitHub now. It reads the current file first, makes the change, tells you what changed, and either does the edit in its browser while you watch (asking before it saves) or hands you the file to paste.
